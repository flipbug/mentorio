defmodule MentorioWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MentorioWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MentorioWeb.Gettext, "errors", msg, opts)
    end
  end
